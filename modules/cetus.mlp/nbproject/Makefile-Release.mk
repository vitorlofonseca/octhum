...
${OBJECTDIR}/Classes/Layer.o: Classes/Layer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Layer.o Classes/Layer.cpp

${OBJECTDIR}/Classes/Neuron.o: Classes/Neuron.cpp
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Neuron.o Classes/Neuron.cpp

${OBJECTDIR}/Classes/Synapse.o: Classes/Synapse.cpp
	${MKDIR} -p ${OBJECTDIR}/Classes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Classes/Synapse.o Classes/Synapse.cpp

${OBJECTDIR}/cetus.mlp.o: cetus.mlp.cc
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cetus.mlp.o cetus.mlp.cc
